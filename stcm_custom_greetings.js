...
function getDefaultSystemPromptTemplate() {
    ...
    return [
        ...
        '',
        'Agency rules:',
        '- The character acts with their own agency. Do NOT ask the user to decide what the character will do.',
        '- If a branching moment is useful, pose options for {{user}}’s next move (actions, dialogue, thoughts), not the character’s.',
        '- Prefer a decisive, proactive action by the character; keep the hook centered on {{user}}.',
        '',
        ...
        '  (a) directly addressing {{user}} with a **specific, scene-grounded** question, or',
        '  (b) describing {{user}} participating in the scene in third person.',
        'Do not alter the braces, casing, or spacing of {{user}}.',
        '',
        'ABSOLUTE NO‑NOs (reject these patterns):',
        '- Generic prompts such as: "What would {{user}} do at this moment?", "What will you do?", "How do you respond?", "What happens next?", "Your move."',
        '- Stock, meta, or rhetorical questions that do not reference concrete details from the scene.',
        '- Empty imperatives like "Decide" or "Choose" without specifying believable options grounded in the scene.',
        '',
        'Instead, ASK CONCRETELY with stakes or constraints. Example pattern:',
        '- "With the siren getting closer and the key still warm in your palm, do you slip it under the ledger or hand it to the clerk, {{user}}?"',
        '',
