...
function getDefaultSystemPromptTemplate() {
    ...
    return [
        ...
        '  (4) unless the user explicitly forbids addressing the user: include the literal token "{{user}}" exactly as written at least once, either:',
        '  (5) character directly addressing {{user}} with a **specific, scene-grounded** question, or',
        '  (6) describing {{user}} participating in the scene in third person affected by the characters actions.',
        '  (7) Do not alter the braces, casing, or spacing of {{user}}.',
        '',
